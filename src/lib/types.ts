...
export const MOCK_ORDERS: Order[] = [
  { id: 'o1', passenger_phone: '+998901111111', passenger_name: 'Nilufar', pickup_zone: 'Gurlan Markaz', drop_zone: 'Bozor', estimated_km: 2, start_price: 3000, km_price: 5000, operator_add: 0, total_price: 13000, bonus_used: 0, status: 'COMPLETED', dispatch_state: 'GREEN_PUBLIC', accepted_by_driver_id: 'd1', created_at: new Date().toISOString(), completed_at: new Date().toISOString() },
  { id: 'o2', passenger_phone: '+998902222222', passenger_name: 'Akbar', pickup_zone: 'Shifoxona', drop_zone: "Temiryo'l", estimated_km: 5, start_price: 3000, km_price: 5000, operator_add: 2000, total_price: 30000, bonus_used: 0, status: 'IN_TRIP', dispatch_state: 'RED_TARGETED', targeted_driver_id: 'd2', accepted_by_driver_id: 'd2', created_at: new Date().toISOString() },
  { id: 'o3', passenger_phone: '+998903333333', pickup_zone: 'Yangi massiv', estimated_km: 3, start_price: 3000, km_price: 5000, operator_add: 0, total_price: 18000, bonus_used: 0, status: 'CREATED', dispatch_state: 'RED_TARGETED', targeted_driver_id: 'd3', created_at: new Date().toISOString() },
  { id: 'o4', passenger_phone: '+998904444444', passenger_name: 'Dilorom', pickup_zone: 'Maktab', drop_zone: 'Gurlan Markaz', estimated_km: 4, start_price: 3000, km_price: 5000, operator_add: 1000, total_price: 24000, bonus_used: 600, status: 'ACCEPTED', dispatch_state: 'GREEN_PUBLIC', accepted_by_driver_id: 'd5', created_at: new Date().toISOString() },
  { id: 'o5', passenger_phone: '+998905555555', pickup_zone: 'Beruniy', drop_zone: 'Poliklinika', estimated_km: 6, start_price: 3000, km_price: 5000, operator_add: 0, total_price: 33000, bonus_used: 0, status: 'CANCELLED', dispatch_state: 'GREEN_PUBLIC', created_at: new Date().toISOString(), cancelled_reason: 'Yo\'lovchi bekor qildi' },
];
